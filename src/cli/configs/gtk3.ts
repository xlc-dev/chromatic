...
function buildGtkDefineColorBlock(scheme: ColorScheme): string {
  ...
  return [
    ...
    `@define-color theme_selected_bg_color ${accentBg};`,
...
notebook tab {
  color: @insensitive_fg_color;
  background-color: mix(@card_bg_color, @theme_fg_color, 0.08);
  border-color: @border_color;
  background-image: none;
  border-style: solid;
  border-width: 1px;
...
notebook tab:hover {
  color: @theme_fg_color;
  background-color: mix(@card_bg_color, @theme_fg_color, 0.14);
  border-color: @hover_border_color;
  box-shadow: none;
}
...
notebook > header.left tab:checked {
  border-right-color: @theme_bg_color;
}
