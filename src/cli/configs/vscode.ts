...
export function createTheme(scheme: ColorScheme) {
  return {
    ...
    colors: {
      ...
      "sideBar.background": scheme.black,
      ...
      "activityBar.background": scheme.black,
      ...
      "statusBar.background": scheme.black,
      "statusBar.foreground": scheme.foreground,
      "statusBar.noFolderBackground": scheme.black,
      "statusBar.debuggingBackground": scheme.red,
      "statusBar.debuggingForeground": scheme.background,
      "titleBar.activeBackground": scheme.black,
      "titleBar.activeForeground": scheme.foreground,
      "titleBar.inactiveBackground": scheme.black,
      "titleBar.inactiveForeground": scheme.brightBlack,
      "editorGroupHeader.tabsBackground": scheme.black,
      "editorGroupHeader.noTabsBackground": scheme.black,
      "editorGroup.emptyBackground": scheme.black,
      "tab.activeBackground": scheme.background,
      "tab.activeForeground": scheme.foreground,
      "tab.inactiveBackground": scheme.black,
      "tab.inactiveForeground": scheme.brightBlack,
      "tab.unfocusedActiveBackground": scheme.background,
      "tab.unfocusedInactiveBackground": scheme.black,
      "tab.border": scheme.brightBlack,
      "tab.activeBorder": scheme.blue,
      "panel.background": scheme.black,
      "panel.border": scheme.brightBlack,
...
export function configureVSCode(scheme: ColorScheme, extensionDir?: string): void {
  ...
  const baseDir = extensionDir ?? join(homedir(), ".vscode", "extensions");
